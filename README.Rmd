...
```{r }
#setwd("C:\\Users\\admin\\Dropbox\\Coursera_DataScienceSpecialization\\Exploratory Data Analysis\\project\\ExploratoryDataAnalysisProj1")
...
dataset01 <- read.table(dataset_file, header= TRUE, sep = ";",na.strings="?",  skip = skip1, nrows = nrows_20070201)
View(dataset01)
...
colnames()
dataset02 <- read.table(dataset_file, header= TRUE, sep = ";",na.strings="?",  skip = skip2, nrows = nrows_20070202)
View(dataset02)
